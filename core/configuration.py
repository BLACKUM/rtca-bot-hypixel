...
class BotConfig:
    def __init__(self, file_path=CONFIG_FILE, load_from_file=True):
        ...
        self.api_priority: List[str] = ["plain_dawn", "adjectils", "soopy", "skycrypt"]
    ...
    def _update_from_dict(self, data: Dict[str, Any]):
        ...
        if "api_priority" in data:
            ...
            self.api_priority = [data["primary_api"]] + [api for api in ["plain_dawn", "adjectils", "soopy", "skycrypt"] if api != data["primary_api"]]
