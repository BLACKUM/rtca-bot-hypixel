...
class DailyView(View):
    ...
    @discord.ui.button(label="Today", style=discord.ButtonStyle.primary, disabled=True, row=0)
    ...
    @discord.ui.button(label="Personal", style=discord.ButtonStyle.success, row=0)
    async def personal_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.mode = "personal"
        await self.update_message(interaction)

    @discord.ui.button(label="Force Update", style=discord.ButtonStyle.danger, row=0)
    ...
    @discord.ui.button(label="📍 Show Me", style=discord.ButtonStyle.primary, row=1)
    async def show_me_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
